...
export class UserService {
  ...
  updateAddress(user): Observable<ApiResponse> {
    console.log("in update address id : " + user.id);
    return this.http.put<ApiResponse>(API_PRIVATE_URL + `/updateAddress/${user.id}`, { 
