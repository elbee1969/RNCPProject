//=========== Stl Viewer v1.10, by Omri Rips, Viewstl.com, October 2020 ; admin@viewstl.com ===========
var stl_viewer_script_path = "H:\RNCPProject\front\Front3DePrint\src\stl_viewer\stl_viewer.min.js";
...
function StlViewer(e, t) {
    ...
    this.error = null, this.options = t, this.parent_element = e, this.get_opt = function(e, t) {
        ...
        e.units = e.units ? e.units : "mm", o.set_model_units(e.id, e.units, !0), e.x = e.x ? e.x : 0, e.y = e.y ? e.y : 0, e.z = e.z ? e.z : 0, e.mesh.position.set(e.x, e.y, e.z), e.color ? o.update_mesh_color(e.mesh, e.color, !1) : e.colors && o.update_mesh_color(e.mesh, "#FFFFFF", !0), e.rotationx = e.rotationx ? e.rotationx : 0, e.rotationy = e.rotationy ? e.rotationy : 0, e.rotationz = e.rotationz ? e.rotationz : 0, (e.rotationx || e.rotationy || e.rotationz) && o.set_rotation(e.id, e.rotationx, e.rotationy, e.rotationz);
        var t = void 0 !== e.scale ? e.scale : 1,
            a = void 0 !== e.scalex ? e.scalex : t,
            i = void 0 !== e.scaley ? e.scaley : t,
            s = void 0 !== e.scalez ? e.scalez : t;
        e.scalex = a, e.scaley = i, e.scalez = s, 1 == a && 1 == i && 1 == s || o.scale_geo(e, a, i, s), e.view_edges && o.set_or_update_geo_edges(e, !0), void 0 !== e.opacity && this.set_material_opacity(e.mesh.material, e.opacity), e.animation && (o.animation[e.id] = 1)
        ...
        if (s && s.mesh && s.mesh.geometry) {
            var n = Math.max(s.scalex, .01),
                l = Math.max(s.scaley, .01),
                r = Math.max(s.scalez, .01);
        ...
        var a = o.models[o.models_ref[e]];
        a && a.mesh && (t.length < 6 || ("#" != t.charAt(0) && (t = "#" + t), a.color = t, o.update_mesh_color(a.mesh, t, !t && a.colors)))
        ...
        if (i && i.mesh) {
            ...
            switch (t) {
                case "mm":
                    a && "inch" == i.units && (s = 1 / 25.4), i.units = "mm";
                    break;
                case "inch":
                    a && "mm" == i.units && (s = 25.4), i.units = "inch";
                    break;
                default:
                    return o.model_error("set_model_units - invalid unit " + t)
            }
            1 != s && o.set_scale(i.id, i.scalex * s, i.scaley * s, i.scalez * s)
        }
        ...
        if (n) {
            var l = s ? 1 : 0;
            void 0 !== t && (n.rotationx = t + n.mesh.rotation.x * l, n.mesh.rotation.x = n.rotationx), void 0 !== a && (n.rotationy = a + n.mesh.rotation.y * l, n.mesh.rotation.y = n.rotationy), void 0 !== i && (n.rotationz = i + n.mesh.rotation.z * l, n.mesh.rotation.z = n.rotationz), n.mesh.updateMatrixWorld(), n.edges && o.set_or_update_geo_edges(n, !0)
        }
        ...
        var s = null;
        return e.orig_url && !i ? s = decodeURIComponent(e.orig_url) : e.orig_filename ? s = e.orig_filename : e.temp_filename ? s = e.temp_filename : e.local_file ? e.local_file.name && (s = e.local_file.name) : e.filename && (e.filename instanceof File && (s = File.name), s = e.filename), !s && t ? "model_" + e.id + ".stl" : s ? (a && (s = o.basename(s)), s) : null
        ...
        if (i) return i; - 1 == e.id && (e.id = ++o.max_model_id), o.models.push(e);
        ...
        var o, a, i, s, n, l, r, d, _, c, m, u, f, h, p = e.faces.length,
            g = 0,
            y = 0;
        for (c = 0; c < p; c++) o = e.vertices[e.faces[c].a].x * t, s = e.vertices[e.faces[c].a].y * t, r = e.vertices[e.faces[c].a].z * t, a = e.vertices[e.faces[c].b].x * t, n = e.vertices[e.faces[c].b].y * t, d = e.vertices[e.faces[c].b].z * t, g += -(i = e.vertices[e.faces[c].c].x * t) * n * r + a * (l = e.vertices[e.faces[c].c].y * t) * r + i * s * d - o * l * d - a * s * (_ = e.vertices[e.faces[c].c].z * t) + o * n * _, h = ((m = e.vertices[e.faces[c].a].distanceTo(e.vertices[e.faces[c].b]) * t) + (u = e.vertices[e.faces[c].b].distanceTo(e.vertices[e.faces[c].c]) * t) + (f = e.vertices[e.faces[c].c].distanceTo(e.vertices[e.faces[c].a]) * t)) / 2, y += Math.sqrt(h * (h - m) * (h - u) * (h - f));
        return [Math.abs(g / 6), y, e.faces.length]
        ...
        return Object.keys(o.models_ref).forEach(function(e) {
            ...
            if (a) n.filename = s.id + ".stl";
            else {
                var l = o.get_model_filename(s, !0, t);
                l && (n.filename = l), s.local_file && (n.local_file = s.local_file)
            }
            s.x && (n.x = s.x), s.y && (n.y = s.y), s.z && (n.z = s.z), s.display && (n.display = s.display), s.colors && "#ffffff" == s.color || s.color && (n.color = s.color), s.units && (n.units = s.units), s.rotationx && (n.rotationx = s.rotationx), s.rotationy && (n.rotationy = s.rotationy), s.rotationz && (n.rotationz = s.rotationz), void 0 === s.scale || a || 1 != s.scale && (n.scale = s.scale), 1 == s.scalex || a || (n.scalex = s.scalex), 1 == s.scaley || a || (n.scaley = s.scaley), 1 == s.scalez || a || (n.scalez = s.scalez), void 0 !== s.opacity && 1 != s.opacity && (n.opacity = s.opacity), s.view_edges && (n.view_edges = s.view_edges), s.animation && (n.animation = JSON.parse(JSON.stringify(s.animation)), delete n.animation.start_time, delete n.animation.last_time), i.models[o.models_ref[e]] = n
        }), e ? i : o.json_without_nulls(i)
    }, this.download_vsj = function(e) {
        var t = new Blob([o.get_vsj()], {
                type: "application/json"
            }),
            a = document.createElement("a");
        a.href = window.URL.createObjectURL(t);
        var i = e || "1",
            s = i.toLowerCase().indexOf(".vsj");
        s >= 0 && (i = i.substring(0, s)), i.length < 1 && (i = "1"), window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(t, i + ".vsj") : (a.download = i + ".vsj", a.click())
        ...
        t.file("json_data.vsj", o.json_without_nulls(a.vsj)), Object.keys(a.files).forEach(function(e) {
            var i = o.get_model_filename(a.vsj.models[o.models_ref[a.files[e].id]], !0, !0);
            t.file(i, a.files[e].bin)
        }), t.generateAsync({
            type: "blob"
        }).then(function(t) {
            var o = new Blob([t], {
            ...
            var i = e || "1",
                s = i.toLowerCase().indexOf(".vsb");
            s >= 0 && (i = i.substring(0, s)), i.length < 1 && (i = "1"), window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(o, i + ".vsb") : (a.download = i + ".vsb", a.click())
        })
        ...
        var a = o.models[o.models_ref[e]];
        if (a && a.mesh) {
            var i = new Blob([o.get_stl_bin(e)], {
                    type: "application/sla"
                }),
                s = document.createElement("a");
            s.href = window.URL.createObjectURL(i);
            var n = o.get_model_filename(a, !0, !0, !0),
                l = n.toLowerCase().indexOf(".stl");
            l >= 0 && (n = n.substring(0, l)), n.length < 1 && (n = "1"), window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(i, n + ".stl") : (s.download = n + ".stl", s.click())
        }
        ...
        if (!o.init_done) {
            switch (o.WORLD_X_VECTOR = new THREE.Vector3(1, 0, 0), o.WORLD_Y_VECTOR = new THREE.Vector3(0, 1, 0), o.WORLD_Z_VECTOR = new THREE.Vector3(0, 0, 1), o.edges_material = new THREE.LineBasicMaterial({
                color: 0
        ...
        if (a)
            for (i = 0; i < l; i++) {
                ...
                for (i = 0; i < l; i++) n.push(new THREE.Face3(t[i][0], t[i][1], t[i][2]));
